...
import { employeeInfoInstance, validateAssignedEmployee, validateDepartment, validateEmployeeInDepartment, validateEmployeeNotInDepartment, validateUnassignedEmployee } from "../../utils/validation";
...
describe("Employee", () => {
  ...
  it("should get all existing unassigned and assigned employees (with assigned's departments)", async () => {
    ...
    await fetch("/api/employees/", {method: "GET"})
      .then(res => {
        ...
        .then(json => {
          for(let i = 0; i < departments.length; i++) {
            if(i !== 2) {
              validateDepartment(json.departments[i], departments[i] as Department);
  ...
  it("should create a valid unassigned employee", async () => {
    await fetch("/api/employees/", {method: "POST", body: JSON.stringify(employeeInfoInstance)})
      .then(res => {
        expect(res.status).toEqual(201);
        res.json()
        .then(json => validateUnassignedEmployee(json.employee, {info: employeeInfoInstance, id: "1"}));
      });
  });
  ...
  it("should create a valid assigned employee", async () => {
    ...
    await fetch("/api/employees/", {method: "POST", body: JSON.stringify({...employeeInfoInstance, departmentId: department.id})})
      .then(res => {
        expect(res.status).toEqual(201);
        res.json()
          .then(json => {
            employee = json.employee as Employee;
            validateAssignedEmployee(employee, {info: employeeInfoInstance, id: "1", departmentId: department.id});
          });
      });
    await fetch(`/api/departments/${department.id}/employees`)
    .then(res => {
      expect(res.status === 200);
      res.json()
  ...
  it(`should not create an assigned employee without: ${requiredFieldsString}`, async () => {
    ...
    await fetch("/api/employees", {method: "POST", body: JSON.stringify({departmentId: department.id})})
      .then(res => {
        expect(res.status).toEqual(400);
        expect(res.headers.get("ErrorType")).toEqual("Exclusion");
        res.json()
  ...
  it("should delete a valid assigned employee", async () => {
    const employee = server.create("employee");
    expect(employee.id).toEqual("1");
    const department = server.create("department", {employees: [employee, server.create("employee")]});
    expect(department.id).toEqual("1");

    await fetch(`/api/employees/${department.id}`, {method: "DELETE"})
      .then(res => {
        expect(res.status).toEqual(200);
      });
    await fetch(`/api/departments/${department.id}/employees`)
      .then(res => {
        expect(res.status === 200);
        res.json()
          .then(json => validateEmployeeNotInDepartment(json.employees, {id: employee.id, info: employee.info, departmentId: department.id}));
      });
  });

  it("should not delete an invalid (unassigned) employee", async () => {
    await fetch("/api/employees/1", {method: "DELETE"})
      .then(res => {
        expect(res.status).toEqual(400);
  ...
  it("should update a valid unassigned employee's info to valid info", async () => {
    ...
    await fetch(`/api/employees/${employee.id}`, {method: "PUT", body: JSON.stringify(employeeInfoInstance)})
      .then(res => {
        expect(res.status === 200)
        res.json()
          .then(json => validateUnassignedEmployee(json.employee, {id: employee.id, info: employeeInfoInstance}));
      });
  });
  ...
  it("should update a valid unassigned employee's department to a valid department", async () => {
    ...
    await fetch(`/api/employees/${employee.id}`, {method: "PUT", body: JSON.stringify({...employee.info, departmentId: department.id})})
      .then(res => {
        expect(res.status === 200)
        res.json()
          .then(json => {
            employeeReceived = json.employee;
            validateAssignedEmployee(employeeReceived, {id: employee.id, info: employee.info, departmentId: department.id});
          });
      });
    await fetch(`/api/departments/${department.id}/employees`)
      .then(res => {
        expect(res.status === 200);
        res.json()
          .then(json => validateEmployeeInDepartment(json.employees, employeeReceived));
      });
  });
  ...
  it("should update a valid unassigned employee's department and info to valid department and info", async () => {
    ...
    let employeeReceived: Employee;
    await fetch(`/api/employees/${employee.id}`, {method: "PUT", body: JSON.stringify({...employeeInfoInstance, departmentId: department.id})})
      .then(res => {
        expect(res.status === 200)
        res.json()
          .then(json => {
            employeeReceived = json.employee;
            validateAssignedEmployee(employeeReceived, {id: employee.id, info: employeeInfoInstance, departmentId: department.id})
          });
      });
    await fetch(`/api/departments/${department.id}/employees`)
      .then(res => {
  ...
  it("should update a valid assigned employee's department to a valid department", async () => {
    const employee = server.create("employee");
    expect(employee.id).toEqual("1");
    const oldDepartment = server.create("department", {employees: [employee]});
    expect(oldDepartment.id).toEqual("1");
    const newDepartment = server.create("department");
    expect(newDepartment.id).toEqual("2");

    let employeeReceived: Employee;
    await fetch(`/api/employees/${employee.id}`, {method: "PUT", body: JSON.stringify({...employee.info, departmentId: newDepartment.id})})
      .then(res => {
        expect(res.status === 200)
        res.json()
          .then(json => {
            employeeReceived = json.employee;
            validateAssignedEmployee(employeeReceived, {id: employee.id, info: employee.info, departmentId: newDepartment.id})
          });
      });
    await fetch(`/api/departments/${newDepartment.id}/employees`)
      .then(res => {
        expect(res.status === 200);
        res.json()
          .then(json => {
    ...
    await fetch(`/api/departments/${oldDepartment.id}/employees`)
      .then(res => {
        expect(res.status === 200);
        res.json()
          .then(json => {
  ...
  it("should update a valid assigned employee's department to a valid department and info", async () => {
    ...
    let employeeReceived: Employee;
    await fetch(`/api/employees/${employee.id}`, {method: "PUT", body: JSON.stringify({...employeeInfoInstance, departmentId: newDepartment.id})})
      .then(res => {
        expect(res.status === 200)
        res.json()
          .then(json => {
            employeeReceived = json.employee;
            validateAssignedEmployee(employeeReceived, {id: employee.id, info: employeeInfoInstance, departmentId: newDepartment.id})
          });
      });
    await fetch(`/api/departments/${newDepartment.id}/employees`)
      .then(res => {
  ...
  it(`should not update a valid assigned employee's info without: ${requiredFieldsString}`, async () => {
    ...
    await fetch(`/api/employees/${employee.id}`, {method: "PUT", body: JSON.stringify({})})
      .then(res => {
        expect(res.status).toEqual(400);
        expect(res.headers.get("ErrorType")).toEqual("Exclusion");
        res.json()
  ...
  it("should not update a valid assigned employee's department to an invalid department", async () => {
    ...
    await fetch(`/api/employees/${employee.id}`, {method: "PUT", body: JSON.stringify({...employee.info, departmentId: "2"})})
      .then(res => {
        expect(res.status).toEqual(400);
        expect(res.headers.get("ErrorType")).toEqual("Invalid");
        res.json()
          .then(json => expect(json.errors).toEqual(["departmentId"]));
      });
  });
  ...
  it("should not update a valid unassigned employee's department to an invalid department", async () => {
    ...
    await fetch(`/api/employees/${employee.id}`, {method: "PUT", body: JSON.stringify({...employee.info, departmentId: "1"})})
      .then(res => {
        expect(res.status).toEqual(400);
        expect(res.headers.get("ErrorType")).toEqual("Invalid");
        res.json()
  ...
  it("should not update an invalid employee's info or department", async () => {
    await fetch("/api/employees/1", {method: "PUT", body: JSON.stringify({...employeeInfoInstance, departmentId: "1"})})
      .then(res => {
        expect(res.status).toEqual(400);
        expect(res.headers.get("ErrorType")).toEqual("Invalid");
        res.json()
