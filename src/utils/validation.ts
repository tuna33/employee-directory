...
export const validateRequestBody = (
  ...
  const requiredFields = Object.keys(
    model === "employee" ? employeeInfoInstance : departmentInfoInstance
  );
  if (body === null)
    return {
...
export const validateEmployeeNotInDepartment = (
...
export const validateEmployeeInDepartment = (
  departmentEmployees: Employee[],
  employee: Employee
): void => {
...
export const validateUnassignedEmployee = (
  actual: Employee,
  expected: Employee
): void => {
...
export const validateAssignedEmployee = (
  actual: Employee,
  expected: Employee
): void => {
...
export const validateEmployee = (
  ...
  expect(expected.departmentId).toEqual(
    isUnassigned ? undefined : actual.departmentId
  );
};
